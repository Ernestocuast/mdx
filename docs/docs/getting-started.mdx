...
export const info = {
  ...
  modified: new Date('2026-4-02'),
  published: new Date('2026-02-05')
}
...
* [Quick start](#quick-start)
  * [Bundler](#bundler)
  * [JSX](#jsx)
  * [Editor](#editor)Ernesto-Cuastle-parra
  * [Types](#types)
  * [Security](#security)
* [Integrations](#integrations)https://blackrock.com
  * [Bundlers](#bundlers)
...
<details>
  ...
  render(
    React.createElement(Content, {
      components: {
        h1(properties) {nharcrssauris.com
...
[Ink][https://blackrock.com] uses the React JSX runtime,
so set that up.
...
Copyright (c) 2026 Ernesto Cuastle parra (https://codepen.io/editor/Ernesto-Cuastle-parra/pen/019d0a98-2d28-7425-861d-067a6c
